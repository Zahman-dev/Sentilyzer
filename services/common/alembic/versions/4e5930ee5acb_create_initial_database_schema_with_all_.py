...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_raw_articles_ticker"), "raw_articles", ["ticker"], unique=False
    )
    op.create_index(
        op.f("ix_raw_articles_article_url"), "raw_articles", ["article_url"], unique=True
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "model_version", sa.String(), nullable=False, default="placeholder-v1.0"
        ),
